...
import 'package:safelink/features/preparedness/presentation/mappers/preparedness_presentation_mapper.dart';
...
class PreparednessView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final PreparednessController controller = Get.find<PreparednessController>();
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      gradient: LinearGradient(
                                        colors: category.displayGradientColors,
                                      ),
                                    ),
                                    child: Icon(
