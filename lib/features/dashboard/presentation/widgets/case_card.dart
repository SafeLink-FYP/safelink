...
class CaseCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () => Get.toNamed('/caseDetailView', arguments: caseItem),
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(caseItem.icon, color: AppTheme.white, size: 20.sp),
            ),
            SizedBox(width: 12.w),
            Expanded(
              child: Column(
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: caseItem.statusColor.withValues(alpha: 0.15),
                          borderRadius: BorderRadius.circular(6.r),
                          border: Border.all(
                            color: caseItem.statusColor.withValues(alpha: 0.30),
                          ),
                        ),
                        child: Text(
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: caseItem.priorityColor.withValues(alpha: 0.15),
