...
class MlAlertController extends GetxController {
  ...
  // True once Geolocator has returned a real fix. While false, _lat/_lng
  // hold the Pakistan-centre fallback so ML queries still return useful
  // country-wide data; UIs that surface location-derived information
  // (e.g. MapView) should banner the user that the default is in use.
  ...
  Future<void> _initLocation() async {
    try {
      ...
      // Fall back to Pakistan centre. hasUserLocation stays false so the
      // map view can banner the user that ML queries are country-wide.
    }
